...
#SBATCH --job-name=segformer_b1_gta_train-split_bilateral_train_b
...
main_config="./local_configs/segformer/B1/segformer.b1.512x512.gta2cs.40k.batch2_bilateral.py"

## The name of the working dir where the results are saved. at the end the prefix "_[a..z]" is added.
work_dir_prefix="./work_dirs/gta_train/segformer_b1/segformer.b1.512x512.gta2cs.40k.batch2_bilateral"
