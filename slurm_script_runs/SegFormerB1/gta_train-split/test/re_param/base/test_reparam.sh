...
#SBATCH --job-name=SegFo_B1_gta-train_base_encoder-soup_abc
...
declare -a work_dirs=("./work_dirs/gta_train/segformer_b1/segformer.b1.512x512.gta2cs.40k.batch2_base_a/latest.pth"
                      "./work_dirs/gta_train/segformer_b1/segformer.b1.512x512.gta2cs.40k.batch2_base_b/latest.pth"
                      "./work_dirs/gta_train/segformer_b1/segformer.b1.512x512.gta2cs.40k.batch2_base_c/latest.pth")
