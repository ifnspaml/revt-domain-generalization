...
declare -a work_dirs=("./work_dirs/gta_train/segformer_b1/segformer.b1.512x512.gta2cs.40k.batch2_bilateral_a/latest.pth"
                      "./work_dirs/gta_train/segformer_b1/segformer.b1.512x512.gta2cs.40k.batch2_pixmix_a/latest.pth"
                      "./work_dirs/gta_train/segformer_b1/segformer.b1.512x512.gta2cs.40k.batch2_pixmix_bilateralfilter_a/latest.pth")
