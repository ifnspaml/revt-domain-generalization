...
#SBATCH --job-name=segformer_b3_gta_train-split_bilateral_train_b
...
work_dir_prefix="./work_dirs/gta_train/segformer_b3/segformer.b3.512x512.gta2cs.40k.batch2_bilateral"
