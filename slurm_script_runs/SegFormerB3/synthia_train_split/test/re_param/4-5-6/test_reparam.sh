...
#SBATCH --job-name=SegFo_B3_gta-train_pixmix-bilateral_encoder-soup_abc
...
declare -a work_dirs=("./work_dirs/synthia_train_split/segformer_b3/segformer.b3.512x512.gta2cs.40k.batch2_bilateral_a/latest.pth"
                      "./work_dirs/synthia_train_split/segformer_b3/segformer.b3.512x512.gta2cs.40k.batch2_pixmix_a/latest.pth"
                      "./work_dirs/synthia_train_split/segformer_b3/segformer.b3.512x512.gta2cs.40k.batch2_pixmix_bilateralfilter_a/latest.pth")
