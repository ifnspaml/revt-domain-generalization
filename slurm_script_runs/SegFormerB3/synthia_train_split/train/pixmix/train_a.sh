...
#SBATCH --job-name=segformer_b3_gta_train-split_pixmix_train_a
...
main_config="./local_configs/segformer/B3/segformer.b3.512x512.gta2cs.40k.batch2_pixmix.py"

## The name of the working dir where the results are saved. at the end the prefix "_[a..z]" is added.
work_dir_prefix="./work_dirs/synthia_train_split/segformer_b3/segformer.b3.512x512.gta2cs.40k.batch2_pixmix"
