...
#SBATCH --job-name=segformer_b3_gta_train-split_base_train_b

## Name of the log file
#SBATCH --output=train_b-%j.out

max_iters=40000

## The config that is used for training and testing
main_config="./local_configs/segformer/B3/segformer.b3.512x512.gta2cs.40k.batch2_base.py"

## The name of the working dir where the results are saved. at the end the prefix "_[a..z]" is added.
work_dir_prefix="./work_dirs/synthia_train_split/segformer_b3/segformer.b3.512x512.gta2cs.40k.batch2_base"

## Number of models that are trained and tested
num_models=1

## Defines the starting value for the working dir prefix
work_dir_start_char="b"
