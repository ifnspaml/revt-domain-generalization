...
#SBATCH --job-name=<model_type>_<model_size>_<dataset>_<methods>_ensemble_<a|b|c>

## Name of the log file
#SBATCH --output=train_<a|b|c>-%j.out
...
declare -a work_dirs=("./work_dirs/segformer.b2.512x512.gta2cs.40k.batch2_base_a/latest.pth"
                      "./work_dirs/segformer.b2.512x512.gta2cs.40k.batch2_base_b/latest.pth"
                      "./work_dirs/segformer.b2.512x512.gta2cs.40k.batch2_base_c/latest.pth")
