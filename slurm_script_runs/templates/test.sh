...
#SBATCH --job-name=<model_type>_<model_size>_<dataset>_<methods>_test_<a|b|c>
...
declare -a work_dirs=("./work_dirs/segformer.b2.512x512.gta2cs.40k.batch2_base/latest.pth"
                      "./work_dirs/segformer.b2.512x512.gta2cs.40k.batch2_base/latest.pth"
                      "./work_dirs/segformer.b2.512x512.gta2cs.40k.batch2_base/latest.pth")
