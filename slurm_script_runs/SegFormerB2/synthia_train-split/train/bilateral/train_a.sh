...
#SBATCH --job-name=segformer_b2_gta_train-split_bilateral_train_a
...
main_config="./local_configs/segformer/B2/segformer.b2.512x512.gta2cs.40k.batch2_bilateral.py"

## The name of the working dir where the results are saved. at the end the prefix "_[a..z]" is added.
work_dir_prefix="./work_dirs/synthia_train/segformer_b2/segformer.b2.512x512.gta2cs.40k.batch2_bilateral"
