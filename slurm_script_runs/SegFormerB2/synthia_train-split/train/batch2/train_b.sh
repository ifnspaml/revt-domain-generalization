...
#SBATCH --job-name=segformer_b2_synthia_train-split_batch2_train_b
...
work_dir_prefix="./work_dirs/synthia_train/segformer_b2/segformer.b2.512x512.gta2cs.40k.batch2"
