...
#SBATCH --job-name=segformer_b2_gta_train-split_bilateral_train_b
...
work_dir_prefix="./work_dirs/gta_train/segformer_b2/segformer.b2.512x512.gta2cs.40k.batch2_bilateral"
