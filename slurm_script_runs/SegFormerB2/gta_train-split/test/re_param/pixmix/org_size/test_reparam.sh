...
#SBATCH --job-name=SegFo_B3_gta-train_pixmix_encoder-soup_abc

## Name of the log file
#SBATCH --output=test_abc-%j.out

## The config that is used for training and testing
main_config="./local_configs/segformer/B2/segformer.b2.512x512.gta2cs.40k.batch2_org_size_inference.py"

## The name of the working dir where the results are saved. at the end the prefix "_[a..z]" is added.
declare -a work_dirs=("./work_dirs/gta_train/segformer_b2/segformer.b2.512x512.gta2cs.40k.batch2_pixmix_a/latest.pth"
                      "./work_dirs/gta_train/segformer_b2/segformer.b2.512x512.gta2cs.40k.batch2_pixmix_b/latest.pth"
                      "./work_dirs/gta_train/segformer_b2/segformer.b2.512x512.gta2cs.40k.batch2_pixmix_c/latest.pth")
