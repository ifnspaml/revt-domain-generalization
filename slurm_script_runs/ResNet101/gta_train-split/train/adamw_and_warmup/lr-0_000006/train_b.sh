...
#SBATCH --job-name=DLv3+_r101_gta-train-split_base_lr_0_000006_train
...
main_config="local_configs/ResNet/101/deeplabv3plus.r101.512x512.gta2cs.60k.batch2_adamw.py"

## The name of the working dir where the results are saved. at the end the prefix "_[a..z]" is added.
work_dir_prefix="./work_dirs/DLv3plusR101/deeplabv3plus.r101.512x512.gta2cs.60k.adamw_lr0_000006"
