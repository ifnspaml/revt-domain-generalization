...
#SBATCH --job-name=deeplabv3plus_r101_gta_train-split_bilateral_train_b
...
main_config="./local_configs/ResNet/101/deeplabv3plus.r101.512x512.gta2cs.40k.batch2_bilateral.py"

## The name of the working dir where the results are saved. at the end the prefix "_[a..z]" is added.
work_dir_prefix="./work_dirs/gta_train/deeplabv3plus_r101/deeplabv3plus.r101.512x512.gta2cs.40k.batch2_bilateral"
