...
#SBATCH --job-name=DLv3+_r101_gta-train-split_reparam_all_abc
...
declare -a work_dirs=("./work_dirs/DLv3plusR101/deeplabv3plus_r101.b5.512x512.gta2cs.40k.batch2_backbone_fixed4k_a/latest.pth"
                      "./work_dirs/DLv3plusR101/deeplabv3plus_r101.b5.512x512.gta2cs.40k.batch2_backbone_fixed4k_b/latest.pth"
                      "./work_dirs/DLv3plusR101/deeplabv3plus_r101.b5.512x512.gta2cs.40k.batch2_backbone_fixed4k_c/latest.pth")
