...
#SBATCH --job-name=DLv3+_r101_gta-train-split_reparam_encoder_abc

## Name of the log file
#SBATCH --output=test_abc-%j.out

## The config that is used for training and testing
main_config="./local_configs/ResNet/101/deeplabv3plus.r101.512x512.gta2cs.40k.batch2_org_size_inference.py"

## The name of the working dir where the results are saved. at the end the prefix "_[a..z]" is added.
declare -a work_dirs=("./work_dirs/gta_train/deeplabv3plus_r101/deeplabv3plus.r101.512x512.gta2cs.40k.batch2_bilateral_a/latest.pth"
                      "./work_dirs/gta_train/deeplabv3plus_r101/deeplabv3plus.r101.512x512.gta2cs.40k.batch2_pixmix_a/latest.pth"
                      "./work_dirs/gta_train/deeplabv3plus_r101/deeplabv3plus.r101.512x512.gta2cs.40k.batch2_pixmix_bilateral_a/latest.pth")
