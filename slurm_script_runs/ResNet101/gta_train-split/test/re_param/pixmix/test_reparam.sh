...
declare -a work_dirs=("./work_dirs/gta_train/deeplabv3plus_r101/deeplabv3plus.r101.512x512.gta2cs.40k.batch2_pixmix_a/latest.pth"
                      "./work_dirs/gta_train/deeplabv3plus_r101/deeplabv3plus.r101.512x512.gta2cs.40k.batch2_pixmix_b/latest.pth"
                      "./work_dirs/gta_train/deeplabv3plus_r101/deeplabv3plus.r101.512x512.gta2cs.40k.batch2_pixmix_c/latest.pth")
