...
#SBATCH --job-name=SegFo_B5_gta-dev_base_encoder-soup_different-complete_abc
...
#only attention_layers, only convolution layers, only mic FFN, only MLP, only path embedding,
declare -a regexes=(".*")
