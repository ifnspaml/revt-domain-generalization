...
#SBATCH --job-name=SegFo_B5_gta-train-split_pixmix_test_encoder_soup_same_seed-w-head_abc
...
declare -a work_dirs=("./work_dirs/gta_train_split/segformer.b5.512x512.gta2cs.40k.batch2_base_i/latest.pth"
