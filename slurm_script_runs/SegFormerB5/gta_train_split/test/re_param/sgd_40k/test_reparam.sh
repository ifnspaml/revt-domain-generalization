...
#SBATCH --job-name=SegFo_B5_gta-train-split_sgd_encoder_soup_abc
...
declare -a work_dirs=("./work_dirs/gta_train/segformer_b5/segformer.b5.512x512.gta2cs.40k.batch2_sgd_a/latest.pth"
                      "./work_dirs/gta_train/segformer_b5/segformer.b5.512x512.gta2cs.40k.batch2_sgd_b/latest.pth"
                      "./work_dirs/gta_train/segformer_b5/segformer.b5.512x512.gta2cs.40k.batch2_sgd_c/latest.pth")
