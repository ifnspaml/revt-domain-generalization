...
#SBATCH --job-name=SegFo_B5_gta-dev_base_decoder-soup_different-layer-types_abc
...
declare -a work_dirs=("./work_dirs/gta_train_split/segformer.b5.512x512.gta2cs.40k.batch2_pixmix_bilateralfilter_a/latest.pth"
                      "./work_dirs/gta_train_split/segformer.b5.512x512.gta2cs.40k.batch2_PixMix_a/latest.pth"
                      "./work_dirs/gta_train_split/segformer.b5.512x512.gta2cs.40k.batch2_salt_pepper_noise_pixmix_a/latest.pth")
...
declare -a regexes=("decode_head.*" "decode_head\\.conv_seg\\.weight" "decode_head\\.conv_seg\\.bias" "decode_head\\.linear_c4\\.proj\\.weight" "decode_head\\.linear_c4\\.proj\\.bias" "decode_head\\.linear_c3\\.proj\\.weight" "decode_head\\.linear_c3\\.proj\\.bias" "decode_head\\.linear_c2\\.proj\\.weight" "decode_head\\.linear_c2\\.proj\\.bias" "decode_head\\.linear_c1\\.proj\\.weight" "decode_head\\.linear_c1\\.proj\\.bias" "decode_head\\.linear_fuse\\.conv\\.weight" "decode_head\\.linear_fuse\\.bn\\.weight" "decode_head\\.linear_fuse\\.bn\\.bias" "decode_head\\.linear_fuse\\.bn\\.running_mean" "decode_head\\.linear_fuse\\.bn\\.running_var" "decode_head\\.linear_fuse\\.bn\\.num_batches_tracked" "decode_head\\.linear_pred\\.weight" "decode_head\\.linear_pred\\.bias")
######################################################################################
