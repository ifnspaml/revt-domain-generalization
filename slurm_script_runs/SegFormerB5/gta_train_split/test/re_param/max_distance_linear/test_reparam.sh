...
declare -a work_dirs=("./work_dirs/gta_train_split/segformer.b5.512x512.gta2cs.40k.batch2_base_a/latest.pth"
                      "./work_dirs/gta_train/segformer_b5/segformer.b5.512x512.gta2cs.40k.batch2_max_distance_linear_c/latest.pth")

declare -a merge_orders=("0;1" "1;2")
