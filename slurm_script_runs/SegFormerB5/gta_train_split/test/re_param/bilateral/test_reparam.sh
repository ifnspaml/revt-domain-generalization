...
#SBATCH --job-name=SegFo_B5_gta-train-split_bilateral_encoder_soup_abc
...
declare -a work_dirs=("./work_dirs/gta_train_split/segformer.b5.512x512.gta2cs.40k.batch2_bilateral_filter_a/latest.pth"
                      "./work_dirs/gta_train_split/segformer.b5.512x512.gta2cs.40k.batch2_bilateral_filter_b/latest.pth"
                      "./work_dirs/gta_train_split/segformer.b5.512x512.gta2cs.40k.batch2_bilateral_filter_c/latest.pth")
