...
#SBATCH --job-name=<model_type>_<model_size>_<dataset>_<methods>_encoder-soup_<a|b|c>
...
declare -a work_dirs=("./work_dirs/gta_train/segformer_b5/segformer.b5.512x512.gta2cs.40k.batch2_max_distance_a/latest.pth"
                      "./work_dirs/gta_train/segformer_b5/segformer.b5.512x512.gta2cs.40k.batch2_max_distance_b/latest.pth"
                      "./work_dirs/gta_train/segformer_b5/segformer.b5.512x512.gta2cs.40k.batch2_max_distance_c/latest.pth")
