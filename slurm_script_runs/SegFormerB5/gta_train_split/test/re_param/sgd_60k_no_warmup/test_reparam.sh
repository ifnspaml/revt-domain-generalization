...
#SBATCH --job-name=SegFo_B5_gta-train-split_sgd-no-warmup_encoder_soup_abc
...
declare -a work_dirs=("./work_dirs/gta_train_split/segformer.b5.512x512.gta2cs.60k.batch2.sgd.no-warmup_a/latest.pth"
                      "./work_dirs/gta_train_split/segformer.b5.512x512.gta2cs.60k.batch2.sgd.no-warmup_b/latest.pth"
                      "./work_dirs/gta_train_split/segformer.b5.512x512.gta2cs.60k.batch2.sgd.no-warmup_c/latest.pth")
