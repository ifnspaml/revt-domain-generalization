...
#SBATCH --job-name=SegFo_B5_gta-dev_base_all-soup_different-layer-types_abc2
...
declare -a work_dirs=("./work_dirs/gta_train_split/segformer.b5.512x512.gta2cs.40k.batch2_pixmix_bilateralfilter_a/latest.pth"
                      ...
                      "./work_dirs/gta_train_split/segformer.b5.512x512.gta2cs.40k.batch2_pixmix_bilateralfilter_b/latest.pth"
                      "./work_dirs/gta_train_split/segformer.b5.512x512.gta2cs.40k.batch2_PixMix_b/latest.pth"
                      "./work_dirs/gta_train_split/segformer.b5.512x512.gta2cs.40k.batch2_salt_pepper_noise_pixmix_b/latest.pth"
                      "./work_dirs/gta_train_split/segformer.b5.512x512.gta2cs.40k.batch2_pixmix_bilateralfilter_c/latest.pth"
                      "./work_dirs/gta_train_split/segformer.b5.512x512.gta2cs.40k.batch2_PixMix_c/latest.pth"
                      "./work_dirs/gta_train_split/segformer.b5.512x512.gta2cs.40k.batch2_salt_pepper_noise_pixmix_c/latest.pth")

declare -a merge_orders=("0;1;2" "1;2;0" "2;0;1" "3;4;5" "4;5;3" "5;3;4" "6;7;8" "7;8;6" "8;6;7")
