...
#SBATCH --job-name=SegFormer_B5_gta-trainset_different2_ensemble_abc
...
declare -a work_dirs=("./work_dirs/gta_train_split/segformer.b5.512x512.gta2cs.40k.batch2_base_a/latest.pth"
                      ...
                      "./work_dirs/gta_train_split/segformer.b5.512x512.gta2cs.40k.batch2_pixmix_bilateralfilter_a/latest.pth"
...
declare -a ensemble_orders=("0;3;6" "1;4;7" "2;5;8")
