...
#SBATCH --job-name=SegFo_B5_gta-train-split_wo_PhotoAug_train_b
...
work_dir_prefix="./work_dirs/gta_train_split/segformer.b5.512x512.gta2cs.40k.batch2_noPhotoAug"
