...
#SBATCH --job-name=segformer_b5_gta_train-split_PixMix_train_d
...
work_dir_prefix="./work_dirs/gta_train_split/segformer.b5.512x512.gta2cs.40k.batch2_PixMix"

## Number of models that are trained and tested
num_models=1

## Defines the starting value for the working dir prefix
work_dir_start_char="d"
