...
#SBATCH --exclude=gpu[04,01,02,05,06]

######################################################################################
### Parameters:

## Name of the job script
#SBATCH --job-name=SegFo_B5_gta-train-split_pixmix_bilateral_train_b
...
work_dir_prefix="./work_dirs/gta_train_split/segformer.b5.512x512.gta2cs.40k.batch2_pixmix_bilateralfilter"
