...
#SBATCH --job-name=SegFo_B5_gta-train-split_wo_PhotoAug_randomflip_train_f

## Name of the log file
#SBATCH --output=train_f-%j.out
...
work_dir_prefix="./work_dirs/gta_train_split/segformer.b5.512x512.gta2cs.40k.batch2_noPhotoAug_RandomFlip"

## Number of models that are trained and tested
num_models=1

## Defines the starting value for the working dir prefix
work_dir_start_char="f"
