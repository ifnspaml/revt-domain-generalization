...
#SBATCH --job-name=SegFormer_B5_synthia-train-split_pixmix_train_b
...
work_dir_prefix="./work_dirs/synthia_train_split/segformer.b5.512x512.gta2cs.40k.batch2_PixMix"
