...
declare -a work_dirs=("./work_dirs/synthia_train_split/segformer.b5.512x512.gta2cs.40k.batch2_noPhotoAug_RandomFlip_a/latest.pth"
                      "./work_dirs/synthia_train_split/segformer.b5.512x512.gta2cs.40k.batch2_noPhotoAug_RandomFlip_b/latest.pth"
                      "./work_dirs/synthia_train_split/segformer.b5.512x512.gta2cs.40k.batch2_noPhotoAug_RandomFlip_c/latest.pth")
