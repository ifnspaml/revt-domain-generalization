...
#SBATCH --job-name=SegFormer_B5_synthia-train-split_wo_PhotoAug_randomflip_train_b
...
main_config="./local_configs/segformer/B5/cs/segformer.b5.512x512.gta2cs.40k.batch2_noPhotoAug_RandomFlip.py"

## The name of the working dir where the results are saved. at the end the prefix "_[a..z]" is added.
work_dir_prefix="./work_dirs/synthia_train_split/segformer.b5.512x512.gta2cs.40k.batch2_noPhotoAug_RandomFlip"
