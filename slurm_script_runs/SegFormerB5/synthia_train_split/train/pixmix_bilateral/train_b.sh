...
#SBATCH --exclude=gpu[04,02,01,05,06]

######################################################################################
### Parameters:

## Name of the job script
#SBATCH --job-name=SegFormer_B5_synthia-train-split_pixmix_bilateral_train_b
...
main_config="./local_configs/segformer/B5/cs/segformer.b5.512x512.gta2cs.40k.batch2_pixmix_bilateralfilter.py"

## The name of the working dir where the results are saved. at the end the prefix "_[a..z]" is added.
work_dir_prefix="./work_dirs/synthia_train_split/segformer.b5.512x512.gta2cs.40k.batch2_pixmix_bilateralfilter"
