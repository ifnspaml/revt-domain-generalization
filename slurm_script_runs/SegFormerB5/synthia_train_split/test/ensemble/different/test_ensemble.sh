...
#SBATCH --job-name=SegFormer_B5_gta-trainset_different_ensemble_abc
...
declare -a work_dirs=("./work_dirs/synthia_train_split/segformer.b5.512x512.gta2cs.40k.batch2_a/latest.pth"
                      ...
                      "./work_dirs/synthia_train_split/segformer.b5.512x512.gta2cs.40k.batch2_PixMix_a/latest.pth"
                      "./work_dirs/synthia_train_split/segformer.b5.512x512.gta2cs.40k.batch2_PixMix_b/latest.pth"
                      "./work_dirs/synthia_train_split/segformer.b5.512x512.gta2cs.40k.batch2_PixMix_c/latest.pth"
                      "./work_dirs/synthia_train_split/segformer.b5.512x512.gta2cs.40k.batch2_sam_adamw_a/latest.pth"
                      "./work_dirs/synthia_train_split/segformer.b5.512x512.gta2cs.40k.batch2_sam_adamw_b/latest.pth"
                      "./work_dirs/synthia_train_split/segformer.b5.512x512.gta2cs.40k.batch2_sam_adamw_c/latest.pth")
