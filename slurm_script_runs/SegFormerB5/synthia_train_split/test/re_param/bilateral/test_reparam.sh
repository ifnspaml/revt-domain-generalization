...
#SBATCH --job-name=SegFo_B5_synthia-trainset_encoder-soup_abc
...
declare -a work_dirs=("./work_dirs/synthia_train_split/segformer.b5.512x512.gta2cs.40k.batch2_bilateral_filter_a/latest.pth"
                      "./work_dirs/synthia_train_split/segformer.b5.512x512.gta2cs.40k.batch2_bilateral_filter_b/latest.pth"
                      "./work_dirs/synthia_train_split/segformer.b5.512x512.gta2cs.40k.batch2_bilateral_filter_c/latest.pth")
