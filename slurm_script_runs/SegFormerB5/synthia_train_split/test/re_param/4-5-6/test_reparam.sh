...
declare -a work_dirs=("./work_dirs/synthia_train_split/segformer.b5.512x512.gta2cs.40k.batch2_PixMix_a/latest.pth"
                      "./work_dirs/synthia_train_split/segformer.b5.512x512.gta2cs.40k.batch2_bilateral_filter_a/latest.pth"
                      "./work_dirs/synthia_train_split/segformer.b5.512x512.gta2cs.40k.batch2_pixmix_bilateralfilter_a/latest.pth")
