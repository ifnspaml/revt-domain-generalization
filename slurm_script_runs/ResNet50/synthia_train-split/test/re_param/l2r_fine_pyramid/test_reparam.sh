...
declare -a work_dirs=("./work_dirs/synthia_train/deeplabv3plus_r50/deeplabv3plus_r50.b5.512x512.gta2cs.40k.batch2_base_a/latest.pth"
                      "./work_dirs/synthia_train/deeplabv3plus_r50/deeplabv3plus_r50.b5.512x512.gta2cs.40k.batch2_base_b/latest.pth"
                      "./work_dirs/synthia_train/deeplabv3plus_r50/deeplabv3plus_r50.b5.512x512.gta2cs.40k.batch2_base_c/latest.pth")
...
'(backbone\.stem\..*)|(backbone\.layer1\.0\..*)|(backbone\.layer1\.1\..*)|(backbone\.layer1\.2\..*)|(backbone\.layer2\.0\..*)|(backbone\.layer2\.1\..*)|(backbone\.layer2\.2\..*)|(backbone\.layer2\.3\..*)|(backbone\.layer3\.0\..*)|(backbone\.layer3\.1\..*)|(backbone\.layer3\.2\..*)|(backbone\.layer3\.3\..*)|(backbone\.layer3\.4\..*)|(backbone\.layer3\.5\..*)|(backbone\.layer4\.0\..*)' \
'(backbone\.stem\..*)|(backbone\.layer1\.0\..*)|(backbone\.layer1\.1\..*)|(backbone\.layer1\.2\..*)|(backbone\.layer2\.0\..*)|(backbone\.layer2\.1\..*)|(backbone\.layer2\.2\..*)|(backbone\.layer2\.3\..*)|(backbone\.layer3\.0\..*)|(backbone\.layer3\.1\..*)|(backbone\.layer3\.2\..*)|(backbone\.layer3\.3\..*)|(backbone\.layer3\.4\..*)|(backbone\.layer3\.5\..*)|(backbone\.layer4\.0\..*)|(backbone\.layer4\.1\..*)' \
'(backbone\.stem\..*)|(backbone\.layer1\.0\..*)|(backbone\.layer1\.1\..*)|(backbone\.layer1\.2\..*)|(backbone\.layer2\.0\..*)|(backbone\.layer2\.1\..*)|(backbone\.layer2\.2\..*)|(backbone\.layer2\.3\..*)|(backbone\.layer3\.0\..*)|(backbone\.layer3\.1\..*)|(backbone\.layer3\.2\..*)|(backbone\.layer3\.3\..*)|(backbone\.layer3\.4\..*)|(backbone\.layer3\.5\..*)|(backbone\.layer4\.0\..*)|(backbone\.layer4\.1\..*)|(backbone\.layer4\.2\..*)')
######################################################################################
