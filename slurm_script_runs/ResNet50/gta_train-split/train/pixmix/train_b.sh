...
#SBATCH --job-name=deeplabv3plus_r50_gta_train-split_pixmix_train_b
...
work_dir_prefix="./work_dirs/gta_train/deeplabv3plus_r50/deeplabv3plus.r50.512x512.gta2cs.40k.batch2_pixmix"
