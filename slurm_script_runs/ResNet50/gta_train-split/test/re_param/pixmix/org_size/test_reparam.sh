...
#SBATCH --job-name=DLv3+_r50_gta-train-split_reparam_encoder_pixmix_abc
...
declare -a work_dirs=("./work_dirs/gta_train/deeplabv3plus_r50/deeplabv3plus.r50.512x512.gta2cs.40k.batch2_pixmix_a/latest.pth"
                      ...
                      "./work_dirs/gta_train/deeplabv3plus_r50/deeplabv3plus.r50.512x512.gta2cs.40k.batch2_pixmix_c/latest.pth")
