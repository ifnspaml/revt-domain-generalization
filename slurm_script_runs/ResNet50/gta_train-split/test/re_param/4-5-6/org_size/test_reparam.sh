...
main_config="./local_configs/ResNet/50/deeplabv3plus.r50.512x512.gta2cs.40k.batch2_org_size_inference.py"

## The name of the working dir where the results are saved. at the end the prefix "_[a..z]" is added.
declare -a work_dirs=("./work_dirs/gta_train/deeplabv3plus_r50/deeplabv3plus.r50.512x512.gta2cs.40k.batch2_pixmix_a/latest.pth"
                      "./work_dirs/gta_train/deeplabv3plus_r50/deeplabv3plus.r50.512x512.gta2cs.40k.batch2_bilateral_a/latest.pth"
                      "./work_dirs/gta_train/deeplabv3plus_r50/deeplabv3plus.r50.512x512.gta2cs.40k.batch2_pixmix_bilateral_a/latest.pth")
