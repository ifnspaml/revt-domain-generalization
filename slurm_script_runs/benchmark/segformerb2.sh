...
#SBATCH --job-name=segformerB2_Benchmark

## Name of the log file
#SBATCH --output=segformerB2_Benchmark-%j.out
...
srun python ./tools/benchmark.py local_configs/segformer/B2/segformer.b2.512x512.gta2cs.40k.batch2.py