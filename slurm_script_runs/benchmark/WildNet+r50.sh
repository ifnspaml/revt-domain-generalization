...
#SBATCH --job-name=WildNet+r50.sh_Benchmark

## Name of the log file
#SBATCH --output=WildNet+r50.sh_Benchmark-%j.out
...
srun python ./tools/benchmark.py local_configs/ResNet/50/WildNetR50.b5.512x512.gta2cs.40k.batch2.py