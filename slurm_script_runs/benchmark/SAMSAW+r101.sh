...
#SBATCH --job-name=SAMSAW+r101.sh_Benchmark

## Name of the log file
#SBATCH --output=SAMSAW+r101.sh_Benchmark-%j.out
...
srun python ./tools/benchmark.py local_configs/ResNet/101/SAMSAWR101.b5.512x512.gta2cs.40k.batch2.py