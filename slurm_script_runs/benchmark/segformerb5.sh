...
#SBATCH --job-name=segformerB5_Benchmark

## Name of the log file
#SBATCH --output=segformerB5_Benchmark-%j.out
...
srun python ./tools/benchmark.py local_configs/segformer/B5/segformer.b5.512x512.gta2cs.40k.batch2.py