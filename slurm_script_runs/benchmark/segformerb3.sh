...
#SBATCH --job-name=segformerB3_Benchmark

## Name of the log file
#SBATCH --output=segformerB3_Benchmark-%j.out
...
srun python ./tools/benchmark.py local_configs/segformer/B3/segformer.b3.512x512.gta2cs.40k.batch2_base.py