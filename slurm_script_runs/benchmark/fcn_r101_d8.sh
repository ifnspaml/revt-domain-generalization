...
#SBATCH --job-name=fcn_r101_d8_Benchmark

## Name of the log file
#SBATCH --output=fcn_r101_d8_Benchmark-%j.out
...
srun python ./tools/benchmark.py local_configs/ResNet/101/fcn_r101b-d8_512x512_40k_cityscapes.py