...
# optimizer
optimizer = dict(_delete_=True, type='StochasticWeightAveraging', swa_start=30000, subtype='AdamW', swa_freq=10, swa_lr=0.000015, lr=0.00006, betas=(0.9, 0.999), weight_decay=0.01,
